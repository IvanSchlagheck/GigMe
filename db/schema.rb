...
ActiveRecord::Schema.define(version: 2021_12_01_111352) do
  ...
  create_table "artist_profils", force: :cascade do |t|
    t.string "artistname"
    t.string "genre"
    t.string "instagram"
    t.string "bandcamp"
    ...
    t.index ["user_id"], name: "index_artist_profils_on_user_id"
  end
  ...
  add_foreign_key "artist_profils", "users"
